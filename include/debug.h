...
#define DBG_LOG_LEVEL_DEFAULT   (DBG_LOG_LEVEL_OFF | DBG_CLASS_WARN | DBG_CLASS_INFO)
#define DBG_LOG_LEVEL_EXTREME   (DBG_LOG_LEVEL_DEFAULT | DBG_CLASS_STATE | DBG_CLASS_EVENT | DBG_CLASS_TRACE | DBG_CLASS_LOUD | DBG_CLASS_TEMP)
